...
namespace Web_Services.Weather {
    ...
    public interface WeatherSoap {
        ...
        Web_Services.Weather.GetWeatherInformationResponse GetWeatherInformation(Web_Services.Weather.GetWeatherInformationRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://ws.cdyne.com/WeatherWS/GetWeatherInformation", ReplyAction="*")]
        System.Threading.Tasks.Task<Web_Services.Weather.GetWeatherInformationResponse> GetWeatherInformationAsync(Web_Services.Weather.GetWeatherInformationRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://ws.cdyne.com/WeatherWS/GetCityForecastByZIP", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        Web_Services.Weather.ForecastReturn GetCityForecastByZIP(string ZIP);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://ws.cdyne.com/WeatherWS/GetCityForecastByZIP", ReplyAction="*")]
        System.Threading.Tasks.Task<Web_Services.Weather.ForecastReturn> GetCityForecastByZIPAsync(string ZIP);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://ws.cdyne.com/WeatherWS/GetCityWeatherByZIP", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        Web_Services.Weather.WeatherReturn GetCityWeatherByZIP(string ZIP);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://ws.cdyne.com/WeatherWS/GetCityWeatherByZIP", ReplyAction="*")]
        System.Threading.Tasks.Task<Web_Services.Weather.WeatherReturn> GetCityWeatherByZIPAsync(string ZIP);
    }
    ...
    public partial class GetWeatherInformationResponse {
        ...
        public Web_Services.Weather.WeatherDescription[] GetWeatherInformationResult;
        
        public GetWeatherInformationResponse() {
        }
        
        public GetWeatherInformationResponse(Web_Services.Weather.WeatherDescription[] GetWeatherInformationResult) {
            this.GetWeatherInformationResult = GetWeatherInformationResult;
        }
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface WeatherSoapChannel : Web_Services.Weather.WeatherSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class WeatherSoapClient : System.ServiceModel.ClientBase<Web_Services.Weather.WeatherSoap>, Web_Services.Weather.WeatherSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Web_Services.Weather.GetWeatherInformationResponse Web_Services.Weather.WeatherSoap.GetWeatherInformation(Web_Services.Weather.GetWeatherInformationRequest request) {
            return base.Channel.GetWeatherInformation(request);
        }
        
        public Web_Services.Weather.WeatherDescription[] GetWeatherInformation() {
            Web_Services.Weather.GetWeatherInformationRequest inValue = new Web_Services.Weather.GetWeatherInformationRequest();
            Web_Services.Weather.GetWeatherInformationResponse retVal = ((Web_Services.Weather.WeatherSoap)(this)).GetWeatherInformation(inValue);
            return retVal.GetWeatherInformationResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Web_Services.Weather.GetWeatherInformationResponse> Web_Services.Weather.WeatherSoap.GetWeatherInformationAsync(Web_Services.Weather.GetWeatherInformationRequest request) {
            return base.Channel.GetWeatherInformationAsync(request);
        }
        
        public System.Threading.Tasks.Task<Web_Services.Weather.GetWeatherInformationResponse> GetWeatherInformationAsync() {
            Web_Services.Weather.GetWeatherInformationRequest inValue = new Web_Services.Weather.GetWeatherInformationRequest();
            return ((Web_Services.Weather.WeatherSoap)(this)).GetWeatherInformationAsync(inValue);
        }
        
        public Web_Services.Weather.ForecastReturn GetCityForecastByZIP(string ZIP) {
            return base.Channel.GetCityForecastByZIP(ZIP);
        }
        
        public System.Threading.Tasks.Task<Web_Services.Weather.ForecastReturn> GetCityForecastByZIPAsync(string ZIP) {
            return base.Channel.GetCityForecastByZIPAsync(ZIP);
        }
        
        public Web_Services.Weather.WeatherReturn GetCityWeatherByZIP(string ZIP) {
            return base.Channel.GetCityWeatherByZIP(ZIP);
        }
        
        public System.Threading.Tasks.Task<Web_Services.Weather.WeatherReturn> GetCityWeatherByZIPAsync(string ZIP) {
